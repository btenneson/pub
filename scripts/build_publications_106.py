...
def main():
    ...
    try:
        ...
        if len(expanded["items"]) != 116:
            raise SystemExit(f"Expected 116 cards after restoration, got {len(expanded['items'])}")
