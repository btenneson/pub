...
Let $M^{\#}$ be a coded or tagged copy of the machine, in the spirit of the tagging constructions in \emph{Depths of a Simulation} \cite{depths}. The meta-ATP can then search for derivations of statements such as
\[
...
This construction does not evade Tarski, Goedel, Church, or ordinary consistency limitations. It is most credible for bounded, syntactic, relative, conditional, and verifier-checkable properties. A machine proving a coded local fact about its search is not the same thing as a machine proving its unrestricted global soundness.
\end{caution}
